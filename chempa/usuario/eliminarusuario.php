...
<div class="circulo">
    ...
    <div class="opciones">
<div>Seccion Eliminar Usuario</div>
    </div>
     <style>
    section {
      padding: 62px 0;
                    ...
                    <section id="contact" class="contact">
                        <div class="container" data-aos="fade-up" style="align-items:center ;">
                            ...
                            <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                              <form method="post" action="EliminarUser.php"  class="php-email-form">
                                <div class="row">
                          ...
                          <div class="text-center"><button type="submit">Dar de baja usuario</button></div>
                      </div>
